...
/obj/item/electronic_assembly
	...
	icon = 'modular_skyrat/modules/integrated_electronics/icons/obj/integrated_electronics/electronic_setups.dmi'
	icon_state = "setup_small"
	item_flags = NOBLUDGEON
	custom_materials = null		// To be filled later
	datum_flags = DF_USE_TAG
	var/list/assembly_components = list()
	var/list/ckeys_allowed_to_scan = list() // Players who built the circuit can scan it as a ghost. // what the fuck why
