...
/obj/item/integrated_circuit_printer
	...
	var/fast_clone = TRUE		// If this is false, then cloning will take an amount of deciseconds equal to the metal cost divided by 100.
...
/obj/item/integrated_circuit_printer/attackby(obj/item/O, mob/user)
	/* SKYRAT PORT -- Upgrade disks commented out for now
...
/* SKYRAT PORT -- Upgade disks commented out for now, stuff spawns upgraded
